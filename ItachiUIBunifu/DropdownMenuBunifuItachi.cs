...
{
    public partial class DropdownMenuBunifuItachi : ContextMenuStrip
    {
            //Fields
    ...
    //Constructor
    public DropdownMenuBunifuItachi(IContainer container)
        : base(container)
    {
    }
    //Properties
    ...
    protected override void OnHandleCreated(EventArgs e)
    {
        ...
        public DropdownMenuBunifuItachi()
        {
            InitializeComponent();
        }

        private void DropdownMenuBunifuItachi_Load(object sender, EventArgs e)
        {
