...
{
    public partial class DateTimePickerBunifuItachi : DateTimePicker
    {
        //Fields
        //-> Appearance
        private Color skinColor = Color.Red;
        ...
        private Image calendarIcon = Properties.Resources.icons8_planner_16px_1;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.icons8_planner_16px;
                else calendarIcon = Properties.Resources.icons8_planner_16px_1;
                this.Invalidate();
            }
        }
        ...
        public DateTimePickerBunifuItachi()
        {
            InitializeComponent();
        ...
        private void DateTimePickerBunifuItachi_Load(object sender, EventArgs e)
        {
